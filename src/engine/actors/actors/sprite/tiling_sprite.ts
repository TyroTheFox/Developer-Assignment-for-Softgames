...
import { TilingSpriteCreatorData } from '../../factory_creators/sprite/tiling_sprite_creator';

/**
 * Sprite
 * Displays a Texture to the Screen in an Endless Tiled Way
 * 
 * @class
 * @extends {PIXI.Sprite}
 */
export class TilingSprite extends PIXI.TilingSprite {
    ...
    protected actorData!: TilingSpriteCreatorData;
    ...
    /**
     * @constructor
     * @param {PIXI.TilingSpriteOptions} options 
     * @param {TilingSpriteCreatorData} data 
     * @param {?PIXI.Container} parent 
     */
    constructor(options: PIXI.TilingSpriteOptions, data: TilingSpriteCreatorData, parent?: PIXI.Container) {
        super(options);
